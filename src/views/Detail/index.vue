          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(spuSaleAttr,index) in spuSaleAttrList" :key="spuSaleAttr.id">
                ...
                <dd changepirce="0"  v-for="(spuSaleAttrValue,index) in spuSaleAttr.spuSaleAttrValueList" :key="spuSaleAttrValue.id" :class="{active:spuSaleAttrValue.isChecked==1}" @click="changeActive(spuSaleAttrValue,spuSaleAttr.spuSaleAttrValueList)">{{spuSaleAttrValue.saleAttrName}}</dd>
              </dl>
              <!-- <dl>
...
import { mapGetters } from 'vuex'
  ...
  export default {
    ...
    methods:{
      ...
      async addShopCar(){
      //   let result =  this.$store.dispatch('reqAddOrUpdateShopCart',{skuId:this.$route.params.skuId,skuNum:this.skuNum})
      // }
      try {
        const result = await this.$store.dispatch("reqAddOrUpdateShopCart", {
