      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-for="(attrValue,index) in searchParams.props" :key="index">{{attrValue.split(':')[1]}}<i @click="removeProps(attrValue,index)">x</i></li>
          </ul>
        </div>
            ...
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li :class="{active:isOne}" @click="changeOrder('1')">
                  <a>综合<span v-show="isOne" class="iconfont" :class="{'icon-jiantou_xiangxia_o':isDesc,'icon-jiantou_xiangshang_o':isAsc}"></span></a>
                </li>
                <li :class="{active:isTwo}" @click="changeOrder('2')">
                  <a>价格<span v-show="isTwo" class="iconfont" :class="{'icon-jiantou_xiangxia_o':isDesc,'icon-jiantou_xiangshang_o':isAsc}"></span></a>
                </li>
              </ul>
            </div>
          </div>
              ...
              <li class="yui3-u-1-5" v-for="(good,index) in goodList" :key="good.id">
                <div class="list-wrap">
                  <div class="p-img">
                    ...
                    <img src="./images/mobile01.png" /></router-link>
                  </div>
                  <div class="price">
                    <strong>
                      <em>¥</em>
  ...
  export default {
    ...
    methods:{
      ...
      attrInfo(attr,attrValue){
        ...
        if(this.searchParams.props.push(props)==-1){
